...
(function () {
  ...
  function load() {
    ...
    ['lessons', 'tests', 'belts', 'badges', 'daily', 'arcade'].forEach(function (k) { if (!s[k] || typeof s[k] !== 'object') s[k] = {}; });
  ...
  function quiz(el, qs, opts) {
    ...
    function finish() {
      ...
      $('.qz-retry', el).addEventListener('click', function () { i = 0; score = 0; if (opts.reshuffle) order = sample(); render(); });
